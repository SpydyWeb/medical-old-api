...
{
	public class TransientMemoryPersistenceProvider : IPersistenceProvider, IWorkflowRepository, ISubscriptionRepository, IEventRepository, IScheduledCommandRepository
	{
		...
		public Task<string> CreateEvent(Event newEvent, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.CreateEvent(newEvent);
		}

		public Task<string> CreateEventSubscription(EventSubscription subscription, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.CreateEventSubscription(subscription);
		}

		public Task<string> CreateNewWorkflow(WorkflowInstance workflow, CancellationToken _ = default(CancellationToken))
		{
		...
		public Task<Event> GetEvent(string id, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetEvent(id);
		}

		public Task<IEnumerable<string>> GetEvents(string eventName, string eventKey, DateTime asOf, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetEvents(eventName, eventKey, asOf);
		}

		public Task<IEnumerable<string>> GetRunnableEvents(DateTime asAt, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetRunnableEvents(asAt);
		}

		public Task<IEnumerable<string>> GetRunnableInstances(DateTime asAt, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetRunnableInstances(asAt);
		}

		public Task<IEnumerable<EventSubscription>> GetSubscriptions(string eventName, string eventKey, DateTime asOf, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetSubscriptions(eventName, eventKey, asOf);
		}

		public Task<WorkflowInstance> GetWorkflowInstance(string Id, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.GetWorkflowInstance(Id);
		}

		public Task<IEnumerable<WorkflowInstance>> GetWorkflowInstances(IEnumerable<string> ids, CancellationToken _ = default(CancellationToken))
		{
		...
		public Task MarkEventProcessed(string id, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.MarkEventProcessed(id);
		}

		public Task MarkEventUnprocessed(string id, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.MarkEventUnprocessed(id);
		}

		public Task PersistErrors(IEnumerable<ExecutionError> errors, CancellationToken _ = default(CancellationToken))
		{
			return _innerService.PersistErrors(errors);
		}

		public Task PersistWorkflow(WorkflowInstance workflow, CancellationToken _ = default(CancellationToken))
		{
		...
		public Task TerminateSubscription(string eventSubscriptionId, CancellationToken _ = default(CancellationToken))
		{
