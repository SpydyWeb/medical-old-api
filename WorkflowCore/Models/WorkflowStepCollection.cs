...
{
	public class WorkflowStepCollection : ICollection<WorkflowStep>, IEnumerable<WorkflowStep>, IEnumerable
	{
		...
		{
			return _dictionary.Values.FirstOrDefault((WorkflowStep x) => match(x));
		}
	}
}
